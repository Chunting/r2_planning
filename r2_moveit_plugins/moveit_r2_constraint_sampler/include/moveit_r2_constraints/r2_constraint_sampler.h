...
class MoveItR2ConstraintSamplerAllocator : public constraint_samplers::ConstraintSamplerAllocator
{
public:
    MoveItR2ConstraintSamplerAllocator();
    virtual ~MoveItR2ConstraintSamplerAllocator();
...
class R2KinematicConstraintSampler : public constraint_samplers::ConstraintSampler
{
public:
    R2KinematicConstraintSampler(const planning_scene::PlanningSceneConstPtr &scene, const std::string &group_name);

    virtual ~R2KinematicConstraintSampler()
    {
    }
...
protected:
    ...
    bool loadIKSolver();
    bool samplePose(const constraint_samplers::IKSamplingPose& sampling_pose, const std::vector<int>& priorities, geometry_msgs::Pose& pose,
